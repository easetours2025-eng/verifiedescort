-- Update the trigger function to give 500 KES VIP Elite offer on profile completion
...
BEGIN
  ...
  THEN
    ...
    -- If no subscription exists yet, create the VIP Elite offer
    IF NOT has_active_sub THEN
      trial_start := NOW();
      trial_end := NOW() + INTERVAL '7 days';
      
      -- Create VIP Elite subscription for 1 week with KES 500 value
      INSERT INTO celebrity_subscriptions (
        ...
        trial_end,
        true,
        500  -- KES 500 for 1 week VIP Elite offer
      );
      
      -- Create a verified payment record for tracking with KES 500
