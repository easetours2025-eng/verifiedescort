...
import { MessageCircle, TrendingUp, Users, Filter, X, Calendar, ChevronLeft, ChevronRight } from 'lucide-react';
...
const AdminWhatsAppAnalytics = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Individual WhatsApp Click Records</CardTitle>
        </CardHeader>
        <CardContent>
