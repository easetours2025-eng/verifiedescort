...
import { Phone, MessageCircle, ChevronLeft, ChevronRight, Star, Verified } from 'lucide-react';
        ...
        <div className="relative">
          ...
          {celebrities.length > 2 && (
            <Button
              variant="ghost"
              size="icon"
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-background/90 hover:bg-background shadow-lg hidden sm:flex"
              onClick={() => scroll('left')}
            >
          ...
          <div
            ...
            className="flex gap-4 overflow-x-auto scrollbar-hide pb-4 px-2 sm:px-8 snap-x snap-mandatory"
          ...
          {celebrities.length > 2 && (
            <Button
              variant="ghost"
              size="icon"
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-background/90 hover:bg-background shadow-lg hidden sm:flex"
